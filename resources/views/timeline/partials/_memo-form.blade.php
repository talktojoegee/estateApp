    <div class="modal-header">
        <div class="modal-title text-uppercase">New Memo </div>
    </div>
    <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="to" id="memoTo" class=" form-control memoTo" >
                    ...
                    <div class="row mt-3 from-message">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="postContent" rows="5" id="memo" style="resize: none" placeholder="Type here..." class="form-control content">{{ old('postContent') }}</textarea>
